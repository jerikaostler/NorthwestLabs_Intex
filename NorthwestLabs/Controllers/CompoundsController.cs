...
namespace NorthwestLabs.Controllers
{
    public class CompoundsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "LT,CompoundName,MTD")] Compound compound)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "LT,CompoundName,MTD")] Compound compound)
        {
            if (ModelState.IsValid)
            {
